...
package framework.commands.scope;

import framework.commands.AbstractParentCommand;
...
import framework.commands.CommandMessages.Format;
import framework.commands.SpecificUsageHolder;
import framework.commands.context.CommandContext;
import framework.commands.result.BiResult;
import framework.commands.result.Result;
import framework.commands.sender.Sender;
import framework.commands.suggestion.Suggestions;
