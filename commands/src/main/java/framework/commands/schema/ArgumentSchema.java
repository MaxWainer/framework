...
package framework.commands.schema;

import framework.commands.schema.ArgumentSchemaImpl.BuilderImpl;
...
public interface ArgumentSchema {
  ...
  static ArgumentSchema empty() { return ArgumentSchemaImpl.EMPTY; }
