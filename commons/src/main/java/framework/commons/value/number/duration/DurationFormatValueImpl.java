...
package framework.commons.value.number.duration;

import framework.commons.Enums;
import framework.commons.duration.DurationType;
import framework.commons.value.AbstractFormatValue;
import framework.commons.value.FormatValueConfig;
import framework.commons.value.FormatValueDisplayGroup;
import framework.commons.value.FormatValueDisplaySet;
import framework.commons.value.GroupMapper;
