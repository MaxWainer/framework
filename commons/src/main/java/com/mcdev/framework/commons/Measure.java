...
public final class Measure {
  ...
  public Measure(final @NotNull Runnable runnable) {
    final long start = System.currentTimeMillis();

    Throwable exception = null;
    try {
      runnable.run();
    } catch (final Throwable throwable) { // cehck
      exception = throwable;
    }
  ...
  public static @NotNull Measure.Result measure(final @NotNull Runnable runnable) {
