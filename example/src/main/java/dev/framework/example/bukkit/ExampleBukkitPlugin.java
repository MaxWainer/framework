...
package dev.framework.example.bukkit;

import dev.framework.bukkit.implementation.command.BukkitCommandManager;
import dev.framework.example.bukkit.command.ExampleParent;
