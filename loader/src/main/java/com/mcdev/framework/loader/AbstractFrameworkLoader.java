...
package com.mcdev.framework.loader;

import com.google.inject.Guice;
import com.mcdev.framework.commons.Measure;
import com.mcdev.framework.commons.SneakyThrows;
import com.mcdev.framework.loader.helper.JVMHelper;
import com.mcdev.framework.loader.inject.FrameworkModule;
import com.mcdev.framework.loader.loadstrategy.ClassLoadingStrategy;
import com.mcdev.framework.loader.loadstrategy.version.ReflectionClassLoadingStrategy;
import com.mcdev.framework.loader.loadstrategy.version.TheUnsafeClassLoadingStrategy;
import com.mcdev.framework.loader.plugin.LoadableJavaPlugin;
import com.mcdev.framework.loader.repository.RepositoryManager;
import com.mcdev.framework.loader.repository.dependency.Dependencies;
import com.mcdev.framework.loader.repository.dependency.Dependency;
import com.mcdev.framework.loader.repository.implementation.CentralRepository;
import com.mcdev.framework.loader.resource.ResourceFile;
import com.mcdev.framework.loader.resource.ResourceFileLoader;
import java.io.File;
  ...
  public void load() {
    ...
    for (final Entry<Dependency, String> entry : resourceFile.dependencies().entrySet()) {
      ...
      try {
        ...
        assert outPath != null : "outPath is null!";
